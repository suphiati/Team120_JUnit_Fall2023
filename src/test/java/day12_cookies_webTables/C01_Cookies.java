...
public class C01_Cookies extends TestBase {
    ...
    public void cookieTesti(){
        ...
        //bu şekilde yazdırınca kaç cookie olduğu ve bunların neler olduğu anlaşılmıyor
        ...
        for (Cookie each:cookieSeti
            ...
            if (each.getName().equals("en sevdiğim cookie")){
                yeniCookieEklendiMi=true;
            }
        }

        // yeni cookie eklenmişse yeniCookieEklendiMi'n değeri true olmalı
