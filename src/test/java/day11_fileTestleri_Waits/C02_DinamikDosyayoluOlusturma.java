...
public class C02_DinamikDosyayoluOlusturma {
    ...
    public void test01(){
        ...
        String dinamikDosyaYolu = System.getProperty("user.home") + "\\OneDrive\\Masaüstü\\Selenium icin\\logo.jpg" ;
        System.out.println(dinamikDosyaYolu); //   D:\OneDrive\Masaüstü\Selenium icin\logo.jpg
